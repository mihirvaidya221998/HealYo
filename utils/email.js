...
exports.plainApppointmentBookingConfirmationTemplate = (date, time) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <div>
        ...
        font-family: sans-serif; color: #272727;">
            <h1 style="background: #f6f6f6; padding: 10px;
            text-align: center; color: #272727;"> Your Appointment has been booked for the ${date}</h1>
            <p style="color: #272727; text-align: center;">Please be the on time. Your time allocated is ${time}</p>
        </div>
    </div>
    </body>
    </html>
